...
# create figure
fig, ax = plt.subplots(nrows=4, sharex=False, sharey=False, figsize=(12, 12))
...
ax[0].label_outer()
# plot sly-mel-spec
specshow(mS_z_dB, sr=sr, ax = ax[1], hop_length=256, y_axis='mel', x_axis='s')
ax[1].set_title('NL-mel spec', fontsize = 14.0)
ax[1].label_outer()
# plot sly-mel-spec
# specshow(org_mS_dB, sr=sr, ax = ax[2], hop_length=256, y_axis='mel', x_axis='s')
# ax[2].set_title('org-dtw EL mel spec (U = 0,trim_silence = False))', fontsize = 14.0)
# ax[2].label_outer()
# # plot sly-mel-spec
# specshow(org_nl_dB, sr=sr, ax = ax[3], hop_length=256, y_axis='mel', x_axis='s')
# ax[3].set_title('org-dtw NL mel spec', fontsize = 14.0)
# ax[3].label_outer()
# plot sly-mel-spec
specshow(sly_mS_dB, sr=sr, ax = ax[2], hop_length=256, y_axis='mel', x_axis='s')
ax[2].set_title('syl-aligned dtw EL mel spec (U = 0,trim_silence = False)', fontsize = 14.0)
ax[2].label_outer()
# plot NL-mel-spec
specshow(sly_nl_dB, sr=sr, ax = ax[3], hop_length=256, y_axis='mel', x_axis='s')
ax[3].set_title('syl-aligned dtw NL mel spec', fontsize = 14.0)
ax[3].label_outer()

fig.savefig('Chaaaaaaaange_10_25_fig_spec_librosa.png', dpi=300)
