...
from .layers_pwg import Conv1d
from .layers_pwg import Conv1d1x1
from .layers_pwg import ResidualBlock
from .layers_pwg import ConvInUpsampleNetwork
...
class ParallelWaveGANGenerator(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if upsample_conditional_features:
            ...
            assert upsample_net == "ConvInUpsampleNetwork"
            upsample_params.update({
