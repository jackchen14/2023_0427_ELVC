...
def feature_to_audio():
    ...
    for data_num in range(240) :
        ...
        if output_wav_type == "nl" :
            audio_path = "/home/4TB_storage/hsinhao_storage/AVEL_align/cdvae-align-feature-sly-align/0829_aligned_wav/" + output_file_name + ".wav"
        else :
            audio_path = "/home/4TB_storage/hsinhao_storage/AVEL_align/cdvae-align-feature-sly-align/0829_aligned_wav/" + "EL01_" + output_file_name.split("_")[-1] + ".wav"
